...
function send()
{
      ...
      axios.post('http://192.168.0.6:3090/ncsresult1',
                      {     
                        rnum: 10,
                        id: global.id,
                        tnum: global.test,
    ...
    axios.post('http://192.168.0.6:3090/getncsresult1',
                        {     
                          id: global.id,
                          tdate: global.tdate,
                          sum1: global.sum1 * 5,
...
class NCSList10 extends Component {
  ...
  componentWillMount() {
    axios.get('http://192.168.0.6:3090/ncsquiz10') //axios.post('fdsjsd/access, data).then((res)->)
